...
$payload_GPupdate = $null #bat file to run gp update /force command
$payloadDynamicDNS = $null #Payload to change interface from static dns to "receive dns automatically" from DHCP
...
$col4 = New-Object system.data.datacolumn Building,([string])
